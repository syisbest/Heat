...
public class MainController {
    ...
    public ResultBody getRecord(String station, Integer pageSize, Integer cur,
                                @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss") Date start,
                                @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss") Date end) {
        log.error("{} {} {} {} {}", station, pageSize, cur, start, end);
    ...
    public ResultBody getStationInfo(String name) {
        List<StationInfo> infos = stationInfoMapper.selectList(new QueryWrapper<StationInfo>().select().like("station_name", name));
        return ResultBody.success(infos);
    }
