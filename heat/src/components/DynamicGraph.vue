<template>
  <div>
    <a-form-model layout="inline" :model="formDate" @submit="handleSubmit" @submit.native.prevent>
      ...
      <a-form-model-item label="最大显示时间">
...
export default {
  ...
  methods: {
    handleSubmit() {
      ...
      this.$refs.g1.option.xAxis.data=[]
      this.$refs.g2.option.xAxis.data=[]
      this.$refs.g3.option.xAxis.data=[]
      this.$refs.g4.option.xAxis.data=[]
    },
    initData() {
      ...
      this.$refs.g1.option.title.text = '温度'
      this.$refs.g2.option.title.text = '热量流量'
      this.$refs.g3.option.title.text = '压力'
      this.$refs.g4.option.title.text = '设备状态'
